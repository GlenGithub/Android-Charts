...
public abstract class Quadrant implements IQuadrant {
    ...
    /**
     * @param padding the paddingTop paddingBottom
    ...
    /**
     * @param topnbottom the paddingTop paddingBottom to set
     * @param leftnright the paddingLeft paddingRight to set
     */
    ...
    /**
     * @param top    the paddingTop to set
     * @param right  the paddingLeft to set
     * @param bottom the paddingBottom to set
     * @param left   the paddingRight to set
     */
