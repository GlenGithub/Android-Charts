...
public class CrossLines implements ICrossLines {
    ...
    private String gettext(){
        double value = inChart.touchPointAxisYValue();
        double displayValue = value;
        String axisYDecimalFormat ;
        if (this.decimelNum == 0){
            axisYDecimalFormat = "";
        }else if (this.decimelNum == 1){
            axisYDecimalFormat = ".0";
        }else if (this.decimelNum == 2){
            axisYDecimalFormat = ".00";
        }else if (this.decimelNum == 3){
            axisYDecimalFormat = ".000";
        }else{
            axisYDecimalFormat = ".00";
        }
        if (displayValue < 10000) {
            return new DecimalFormat("##0"+axisYDecimalFormat).format(displayValue);
