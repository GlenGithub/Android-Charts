...
public abstract class DataGridChart extends GridChart implements IDataCursor {
    ...
    public static final int DEFAULT_MAX_LABEL_FILL_COLOR = Color.LTGRAY;
    public static final int DEFAULT_MAX_LABEL_STROKE_COLOR = Color.LTGRAY;
    public static final int DEFAULT_MAX_LABEL_FONT_COLOR = Color.BLACK;
    public static final int DEFAULT_MIN_LABEL_FILL_COLOR = Color.LTGRAY;
    public static final int DEFAULT_MIN_LABEL_STROKE_COLOR = Color.LTGRAY;
    public static final int DEFAULT_MIN_LABEL_FONT_COLOR = Color.BLACK;
    ...
    protected String axisXDateTargetFormat = isFenZhongStyleSelected ? DEFAULT_AXIS_X_DATE_FenZhong_TARGET_FORMAT:DEFAULT_AXIS_X_DATE_DAY_TARGET_FORMAT;
    protected String axisXDateSourceFormat = isFenZhongStyleSelected ? DEFAULT_AXIS_X_DATE_FenZhong_SOURCE_FORMAT:DEFAULT_AXIS_X_DATE_DAY_SOURCE_FORMAT;

    protected boolean displayMaxLabel = DEFAULT_DISPLAY_MAX_LABEL;
    protected boolean displayMinLabel = DEFAULT_DISPLAY_MIN_LABEL;
    protected int maxLabelFillColor = DEFAULT_MAX_LABEL_FILL_COLOR;
    protected int maxLabelStrokeColor = DEFAULT_MAX_LABEL_STROKE_COLOR;
    protected int maxLabelFontColor = DEFAULT_MAX_LABEL_FONT_COLOR;
    protected int minLabelFillColor = DEFAULT_MIN_LABEL_FILL_COLOR;
    protected int minLabelStrokeColor = DEFAULT_MIN_LABEL_STROKE_COLOR;
    protected int minLabelFontColor = DEFAULT_MIN_LABEL_FONT_COLOR;

    public int getMaxLabelFontSize() {
        return maxLabelFontSize;
    }

    public void setMaxLabelFontSize(int maxLabelFontSize) {
        this.maxLabelFontSize = maxLabelFontSize;
    }
    ...
    public void setMinLabelFontSize(int minLabelFontSize) {
        this.minLabelFontSize = minLabelFontSize;
    }

    protected int maxLabelFontSize = DEFAULT_MAX_LABEL_FONT_SIZE;
    protected int minLabelFontSize = DEFAULT_MIN_LABEL_FONT_SIZE;
...
//	protected IDataCursor getDataCursor() = this;
    ...
    public String formatAxisYDegree(double value) {
        //TODO:格式改成属性
        //数据
        double displayValue = Math.round(value) / dataMultiple;
    ...
    public String formatAxisXDegree(long date) {
        try {
            Date dt = new SimpleDateFormat(getAxisXDateSourceFormat(), Locale.getDefault()).parse(String.valueOf(date));
            return new SimpleDateFormat(getAxisXDateTargetFormat(), Locale.getDefault()).format(dt);
    ...
    public String calcAxisYGraduate() {
        double value = this.touchPointAxisYValue();
        return formatAxisYDegree(value);
    }
    ...
    public String getAxisXDateSourceFormat() {
        ...
        return isFenZhongStyleSelected ? DEFAULT_AXIS_X_DATE_FenZhong_SOURCE_FORMAT:DEFAULT_AXIS_X_DATE_DAY_SOURCE_FORMAT;
    }
    ...
    */
    ...
    public boolean isDisplayMaxLabel() {
        return displayMaxLabel;
    }

    public void setDisplayMaxLabel(boolean displayMaxLabel) {
        this.displayMaxLabel = displayMaxLabel;
    }
    ...
    public void setDisplayMinLabel(boolean displayMinLabel) {
        this.displayMinLabel = displayMinLabel;
    }

    public int getMaxLabelFillColor() {
        return maxLabelFillColor;
    }

    public void setMaxLabelFillColor(int maxLabelFillColor) {
        this.maxLabelFillColor = maxLabelFillColor;
    }

    public int getMaxLabelStrokeColor() {
        return maxLabelStrokeColor;
    }

    public void setMaxLabelStrokeColor(int maxLabelStrokeColor) {
        this.maxLabelStrokeColor = maxLabelStrokeColor;
    }

    public int getMaxLabelFontColor() {
        return maxLabelFontColor;
    }

    public void setMaxLabelFontColor(int maxLabelFontColor) {
        this.maxLabelFontColor = maxLabelFontColor;
    }

    public int getMinLabelFillColor() {
        return minLabelFillColor;
    }

    public void setMinLabelFillColor(int minLabelFillColor) {
        this.minLabelFillColor = minLabelFillColor;
    }

    public int getMinLabelStrokeColor() {
        return minLabelStrokeColor;
    }

    public void setMinLabelStrokeColor(int minLabelStrokeColor) {
        this.minLabelStrokeColor = minLabelStrokeColor;
    }

    public int getMinLabelFontColor() {
        return minLabelFontColor;
    }

    public void setMinLabelFontColor(int minLabelFontColor) {
        this.minLabelFontColor = minLabelFontColor;
    }
