...
public class StickChart extends PeriodDataGridChart implements IZoomable {
    ...
    protected int displayStickAsLineWidth = DEFAULT_DISPLAY_STICK_AS_LINE_WIDTH;
    ...
    protected void drawSticksAsLine(Canvas canvas) {
        ...
        mPaintStroke.setStrokeWidth(displayStickAsLineWidth);
...
//        }
        ...
        if (dataCursor.getMinDisplayNumber() >= datasize) {
            ...
            if (datasize < dataCursor.getDisplayNumber()){
                dataCursor.setDisplayNumber(getMinDisplayNumber());
            }else if (dataCursor.getDisplayNumber() < dataCursor.getMinDisplayNumber()){
                dataCursor.setDisplayNumber(getMinDisplayNumber());
            }
            dataCursor.setMaxDisplayNumber(datasize);
            //右侧显示
    ...
    public int getDisplayStickAsLineNumber() {
        return displayStickAsLineNumber;
    }

    public void setDisplayStickAsLineNumber(int displayStickAsLineNumber) {
        this.displayStickAsLineNumber = displayStickAsLineNumber;
    }

    public int getDisplayStickAsLineColor() {
        return displayStickAsLineColor;
    }

    public void setDisplayStickAsLineColor(int displayStickAsLineColor) {
        this.displayStickAsLineColor = displayStickAsLineColor;
    }

    public int getDisplayStickAsLineWidth() {
        return displayStickAsLineWidth;
    }

    public void setDisplayStickAsLineWidth(int displayStickAsLineWidth) {
        this.displayStickAsLineWidth = displayStickAsLineWidth;
    }
    ...
    public int getStickStrokeColor() {
        return stickStrokeColor;
    }

    public void setStickStrokeColor(int stickStrokeColor) {
        this.stickStrokeColor = stickStrokeColor;
    }
