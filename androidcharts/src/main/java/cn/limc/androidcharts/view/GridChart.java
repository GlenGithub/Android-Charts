...
public class GridChart extends AbstractBaseChart implements ITouchable {
    ...
    protected boolean isValidTouchPoint(float x, float y) {
        return !(x < dataQuadrant.getPaddingStartX()
                || x > dataQuadrant.getPaddingEndX()
                || y < dataQuadrant.getPaddingStartY()
     ...
     * @param axisWidth the axisWidth to set
     */
    public void setAxisXHeight(float axisHeight) {
        this.axisX.setHeight(axisHeight);
    }
//
//	/**
...
//	}
    ...
    /**
     * @param quadrantPaddingTop the paddingTop to set
     */
    ...
    /**
     * @param quadrantPaddingLeft the paddingLeft to set
     */
    ...
    /**
     * @param quadrantPaddingBottom the paddingBottom to set
     */
    ...
    /**
     * @param quadrantPaddingRight the paddingRight to set
     */
    ...
    public void setCrossLinesDecimelNumber(int decimelNumber){
        this.crossLines.decimelNum = decimelNumber;
    }
    ...
    public void setDashEffect(PathEffect dashEffect) {
        this.simpleGrid.setDashEffect(dashEffect);
    }
